    ...
    <header>
      ...
      <div className='flex items-center space-x-5 flex-1 justify-end w-full'>
        ...
        <form className='flex items-center space-x-5 bg-white rounded-md p-2 shadow-md flex-1 md:flex-initial'>
          ...
          />
          <button hidden type='submit' className=''>Search</button>
        </form>


        {/* Logo */}

        <Avatar name="Shahzaib Ali" round color="#0055D1" size="50" />
      </div>
      </div>
    
      <div className='flex items-center justify-center px-5 py-2 md:py-5'>
        <p className='flex items-center text-sm font-light pr-5 shadow-xl w-fit rounded-xl italic bg-white max-w-3xl text-[#0055D1] p-5'>
